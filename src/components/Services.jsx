...
const Services = () => {
  ...
  const images = Array.isArray(services[activeIndex].images)
    ? services[activeIndex].images
    : [services[activeIndex].images];
          ...
          {services.map((item, index) => (
            ...
            >
              <button
                ...
                className={`cursor-pointer text-[16px] sm:text-[14px] md:text-[16px] font-semibold text-[#1e1b4b] relative pb-2 ${
                  activeIndex === index
              ...
              <div className="w-full md:w-[55%]">
                ...
                <div className="flex justify-start">
                  <Link
                    ...
                    className=" cursor-pointer mt-6 md:px-18 md:py-4 px-8 py-2 rounded-full text-white text-sm font-semibold font-inter   bg-linear-to-r from-[#3943FF] to-[#2EC8FF] shadow-md hover:opacity-90 transition-all"
                  >
                    Learn more
                  </Link>
                </div>
