...
const HeroSection = () => {
  return (
    <section className="hero-section relative w-full overflow-hidden bg-gradient-to-b from-white via-[#f5f7ff] to-white pt-28 md:pt-40 pb-16 md:pb-24 font-inter">
      ...
      <div className="relative max-w-4xl mx-auto px-4 text-center">
        ...
        <button
          className="
            ...
            w-full sm:w-auto sm:min-w-[180px] md:w-[206px] md:h-[68px]
            px-6 py-3 md:px-[48px] md:py-[20px]
            rounded-[12px] md:rounded-[16px]
            text-sm md:text-base font-medium
            bg-[#111827] text-white
            shadow-md hover:bg-black/90 transition
          "
        >
          Get Started
        </button>
